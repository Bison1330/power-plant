# PR descriptions, as posted

The text of each pull request we opened, kept as the record of what was
claimed at the time. The PR itself is the live version; these are not
updated after posting.

| File | PR | State (2026-09-21) |
| --- | --- | --- |
