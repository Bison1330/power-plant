...
This is enforced in `pallets/vitreus-dex`, not in the launchpad, because the launchpad cannot see or prevent what other callers do to the DEX. Changes beyond `f3350e4`. D1 (`ce34a05`), D2 and D3 (`5ea3008`), D5 (`c7d3752`) and D4 (`d8d0ba0`, `5c80ee3`, `ae8e60c`) are landed and kept here for the record; D6 is written and tested on the branch, pending review.
